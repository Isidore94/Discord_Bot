...
open stock position. Settled option wins/losses fold into the quasi win rate.
If the spot price can't be fetched (network/`yfinance` unavailable), the
position is simply left open and settled on a later run.
